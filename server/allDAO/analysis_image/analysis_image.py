...
class Analysis_image:
    ...
    async def analysis_image(self, photo, processed_img, area):
        ...
        results = self.model.predict(
            ...
            iou=0.6,
            save=False,
            name="acne_yolos_seg_v3_inference",
        ...
        if results:
            ...
            res_img = self.draw_boxes(photo, results, box_color=(0, 255, 0), thickness=5)
